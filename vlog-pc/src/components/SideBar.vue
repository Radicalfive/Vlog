  ...
  <v-card min-width="320">
    <v-img :src="user.avatar" height="300px" class="px-3 py-3" dark ref="img">
      ...
      <v-btn dark icon @click="handleClick" v-if="user.id === loginUser.id">
        <v-icon large color="#4db6ac">mdi-camera</v-icon>
      </v-btn>
    </v-img>

    <v-row class="mt-3 mr-15">
    ...
    <v-list two-line>
      ...
      <v-list-item @click="$router.push('/my/userinfo/usersafe')">
        <v-list-item-icon>
      ...
      <v-list-item @click="$router.push('/my/userinfo/feekback')">
        <v-list-item-icon>
      ...
      <v-list-item @click="$router.push('/my/userinfo/about')">
        <v-list-item-icon>
